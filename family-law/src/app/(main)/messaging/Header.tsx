...
const ROUTES: { path: string; name: string }[] = [
  { path: "/messaging/all", name: "All" },
  { path: "/messaging/email", name: "Email" },
  { path: "/messaging/phone", name: "Phone" },
  { path: "/messaging/fax", name: "Fax" },
  { path: "/messaging/mail", name: "Mail" },
  { path: "/messaging/meeting", name: "Meeting/Appearance" },
];
